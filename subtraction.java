...
class Subtraction
  {
    public static void sub(int arr1[][],int arr2[][],int rows,int columns,int row1,int columns1)
    {
      System.out.println("The subtraction of two matrices are :");
...
public static void main(String args[])
  ...
  for(int i=0;i<row1;i++)
   ...
   sub(arr1,arr2,rows,columns,row1,column1);
  }
}